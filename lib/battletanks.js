...
var BattleTank = function() {
	...
	var Tank = function(tankId, x, y, color, grid) {
		...
		this.showCPU = function() {
			var memPerRow = 10;
			var html = '<div id="ram"><h1>RAM</h1>';
			html += '<table><tr><th>Address</th><th>Data</th><th>Mnenomic</th><th>Details</th></tr>';
			for(var i = 0; i < this.cpu.ram.length; i++) {
				html += '<tr><td>' + i + '</td><td>' + this.cpu.ram[i] + '</td><td><td></td><td></td></tr>'
			}
