...
var BattleTank = function() {
	...
	var Tank = function(tankId, x, y, color, grid) {
		...
		this.showCPU = function() {
			...
			html += '<span id="pc_register" class="register">Program Counter:<input type="text" name="pc_register_value" maxlength="3" size="3" class="register_value" id="pc_register_value" value="0"></span>';
			html += '<span id="ins_register" class="register">Instruction:<input type="text" name="ins_register_value" maxlength="3" size="3" class="register_value" id="ins_register_value" value="0"></span>';
			html += '<span id="ac_register" class="register">Accumulator:<input type="text" name="ac_register_value" maxlength="3" size="3" class="register_value" id="ac_register_value" value="0"></span>';
	...
	this.addTank = function(id, x,y, color) {
		var html = '<div id="tank_' + id + '" class="tank">\
			...
			<div class="tank_quote" id="tank_quote_tank_' + id + '">Waiting...</div>\
	...
	this.setupController = function() {
		...
		if(this.settings.controller == this.CONTROLLER_LITTLE_MAN_COMPUTER) {
			if($('#cpu_controller').length == 0) {
				...
				$('#controller').html('<div id="cpu_controller"><a data-inline="true" data-icon="check" id="btn_run">Run</a><a data-inline="true" data-icon="forward" id="btn_step">Single step</a><a data-inline="true" data-icon="back" id="btn_reset">Reset</a></div>').unbind();
				// run
