...
var BattleTank = function() {
					...
					for(var i = 0; i < grid.mapData[y][x].items.length; i++) {
						...
						switch(item) {
							...
							case bt.ITEM_TYPE_CRATER:
								itemHTML += '<img src="media/crater.png" />';
								break;
							case bt.ITEM_TYPE_AMMO:
								itemHTML += '<img src="media/ammo.gif" />';
								break;
							case bt.ITEM_TYPE_CHECKPOINT:
								itemHTML += '<img src="media/checkpoint.gif" />';
								breakl
	...
	// destroy a tank at a given position
	this.destroyTank = function(x, y) {
