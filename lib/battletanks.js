...
var BattleTank = function() {
	...
	var Tank = function(tankId, x, y, color, grid) {
		...
		this.showCPU = function() {
			...
			html +='</div></div>';
			html += '<div id="control_holder"><div id="input"><h2>Input</h2><table class="device_table"><tr><th>Input device:</th><th>Accumulator</th></tr>';
			...
			html +='<a id="btn_current_input_value" data-iconpos="right" data-inline="true" data-mini="true" data-icon="refresh">Current value: 0</a>Example:<pre id="input_code_sample" class="code_sample">INP 0 // asks the user to enter a number</pre></div>'
