			...
			this.execute = function(opcode) {
				...
				case 7:
					if(this.registers.accumulator == 0) {
						...
						description = "Accumulator was not 0: incrememtn program counter register as normal";
					}
					break;
// TODO: continue from here
		...
		this.showCPU = function() {
			...
			html +='</div></div>';
			html += '<div id="control_holder"><div id="input"><h2>Input</h2><fieldset data-role="controlgroup" data-type="horizontal" id="input_fieldset"><legend>Input device:</legend><label for="select_input_device">Device</label><select data-mini="true" name="select_input_device" id="select_input_device"><option>Text Radio</option><option>Compass</option><option>Radar</option></select><label for="select_input_command">Command</label><select data-mini="true" id="select_input_command" name="select_input_command"><option>Read number</option></select></fieldset></div>'
			...
			html += '<div id="control_status"></div>';
			html += '</div>';
			...
			$('#btn_run_step').button().click(function(){
